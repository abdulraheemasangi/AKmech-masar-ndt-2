...
import { ArrowRight, CheckCircle2, UserCheck, ChevronRight, Users } from 'lucide-react'
    ...
    <div className="bg-white min-h-screen text-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10">
          ...
          >
            ...
            <div className="flex items-center gap-2 text-xs text-gray-400 mb-6">
              ...
              <span>Services</span>
              <ChevronRight className="w-3 h-3 text-orange-400" />
              <span className="text-orange-400 font-semibold">Manpower</span>
            </div>
            ...
            <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl font-black tracking-tight mt-4 leading-[1.1]">
              Technical{' '}
              <span className="text-orange-500">Manpower Supply</span>
            </h1>
            ...
            <div className="mt-10 flex items-center gap-3">
              ...
              <div>
                <p className="font-heading text-xl font-black text-orange-400 leading-none">90k+</p>
                <p className="text-[10px] text-gray-400 uppercase font-semibold tracking-wider mt-0.5">Database Size</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-6 md:px-10 py-20 md:py-28 relative">
        ...
        <div className="text-center mb-12">
          <h2 className="font-heading text-2xl font-extrabold text-gray-900">
            Expert Technical Staffing Solutions
          </h2>
          <p className="text-sm text-gray-500 font-light mt-2">
            Certified professionals for your critical projects
          </p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-10 pb-20 md:pb-28">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-gray-500 font-light mt-2">
            Comprehensive database and deployment statistics
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
          {stats.map((s, idx) => (
            <motion.div
              ...
              className="group bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:shadow-slate-200/60 hover:border-orange-200 hover:-translate-y-1 transition-all duration-300"
            >
              {/* Top gradient bar */}
              ...
              <div className="p-6 text-center relative overflow-hidden">
                {/* Number watermark */}
                <span className="absolute -bottom-2 -right-1 text-6xl font-black text-gray-50 select-none pointer-events-none leading-none">
                  {idx + 1}
                </span>
                <p className="font-heading text-3xl md:text-4xl text-orange-500 font-extrabold tracking-tight leading-none relative z-10">
                  {s.value}
                </p>
                <p className="text-xs text-gray-500 mt-3 leading-snug font-medium relative z-10">
                  {s.label}
                </p>
              </div>
            </motion.div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-8 pb-6 border-b border-gray-100">
            ...
            <div>
              <h3 className="font-heading text-lg font-bold text-slate-800">
                Key Disciplines Supplied
              </h3>
              <p className="text-xs text-gray-500 font-light mt-0.5">
                Specialized technical roles for industrial projects
              </p>
            </div>
          </div>

          <div className="flex flex-wrap gap-3">
            {manpower.disciplines.map((d, idx) => (
              <motion.span
                key={d}
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h3 className="font-heading text-xl font-extrabold text-gray-900 mb-3">
              Need Certified Staff for Your Shutdown?
            </h3>
            <p className="text-gray-500 text-sm font-light leading-relaxed max-w-md mx-auto mb-7">
              Need to mobilize certified inspection staff or technical crews for an upcoming shutdown project? Our team can deploy qualified professionals quickly and efficiently.
            </p>
            <Link
              to="/contact"
