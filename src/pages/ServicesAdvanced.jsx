        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10">
          ...
          >
            ...
            <div className="flex items-center gap-2 text-xs text-gray-400 mb-6">
              ...
              <span>Services</span>
              <ChevronRight className="w-3 h-3 text-orange-400" />
              <span className="text-orange-400 font-semibold">Advanced NDT</span>
            </div>
            ...
            <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl font-black tracking-tight mt-4 leading-[1.1]">
              {advancedNdt.title.split(' ').slice(0, 2).join(' ')}{' '}
              <span className="text-orange-500">{advancedNdt.title.split(' ').slice(2).join(' ')}</span>
            </h1>
            ...
            <div className="mt-10 flex items-center gap-3">
              ...
              <div>
                <p className="font-heading text-xl font-black text-orange-400 leading-none">{advancedNdt.methods.length}</p>
                <p className="text-[10px] text-gray-400 uppercase font-semibold tracking-wider mt-0.5">Advanced Methods</p>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-6 md:px-10 py-20 md:py-28 relative">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-gray-500 font-light mt-2">
            High-precision inspection techniques for critical assets
          </p>
        </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h3 className="font-heading text-xl font-extrabold text-gray-900 mb-3">
              Need Advanced Tube Inspection?
            </h3>
            <p className="text-gray-500 text-sm font-light leading-relaxed max-w-md mx-auto mb-7">
              Planning an upcoming exchanger overhaul project? Our team can provide advanced NDT solutions tailored to your requirements.
            </p>
            <Link
              to="/contact"
